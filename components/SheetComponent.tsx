...
export default function SheetComponent({stave}: { stave: Stave }) {
    return (<div
        className={"bg-white relative min-h-200 h-fit grid grid-cols-[48px_192px_192px_192px] p-7 flex-wrap place-content-start gap-y-16 mx-auto md:mx-0 w-[90vw] md:w-[43em] shadow-md shadow-foreground/50 dark:shadow-none overflow-visible pt-20 mb-4"}>
        {
