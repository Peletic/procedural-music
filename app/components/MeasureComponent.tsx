...
export default function MeasureComponent({value, idxN, last}: { value: Measure, idxN: number, last?: boolean }) {
    ...
    return (<div className={"bg-white h-[7.3em] border-black flex flex-col-reverse justify-between"} style={{width: `${width}em`, borderRight: `${(idxN+1) % 3 == 0 ? "2px" : "0px"} solid black`}}>
        <div className={"h-[3em]"}>
