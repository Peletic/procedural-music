...
export default function MeasureComponent({value, idxN, last}: { value: Measure, idxN: number, last?: boolean }) {
    ...
    return (<div className={"bg-white h-[7.3em] border-black flex flex-col-reverse justify-between"}
        ...
        <div className={"h-[3em]"}>
            <img className={"absolute h-[3em] border-r-[2px] object-fill border-black"} style={{width: `${12.5}em`}}
                 src={"staff.svg"}/>
            {last && <img className={"absolute h-[3em] border-r-[2px] object-fill border-black ml-[6.7em]"} style={{width: `${6}em`}}
                         src={"staff-end.svg"}/>}
        </div>
        <div className={"h-[3em]"}>
            <img className={"absolute h-[3em] border-r-[2px] border-black object-fill"} style={{width: `${12.5}em`}}
                 src={"staff.svg"}/>
